...
namespace RegistryMonitorDemo
{
	...
	public class RegistryMonitorDemoForm : System.Windows.Forms.Form
	{
		...
		private void OnRegChanged(object sender, EventArgs e)
		{
            ...
            string loggedonUser = currentUser.Name;

            string str = currentUser.Name+":"+"Some event occured.Registry has changed:" + CurrTime.Day + ":" + CurrTime.Month + ":" + CurrTime.Year + ":" + CurrTime.TimeOfDay;
            listBox1.Items.Add(str);
            using (StreamWriter w = File.AppendText(@"E:\\IDS final\\IDS Server\\FTPserver\\RegLog.txt"))
            {
                Log(str,w);
